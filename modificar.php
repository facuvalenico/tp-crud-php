...
<br><br><br>
<p class="lead">Modificar proyectos cargados</p>
    <hr class="my-2">
    <br>
                    ...
                    <div class="card-body">
                        ...
                        <form action="#" method="post" enctype="multipart/form-data">
                            ...
                            <div>
                                ...
                                <textarea required class="form-control" name="link" id="link" cols="30" rows="1"><?php echo $fila['link'];?></textarea>
                            </div>
                            <div>
                            <br>
                            <input id="btn-modificar-proyecto" class="btn btn-warning" type="submit" value="Modificar Proyecto">
